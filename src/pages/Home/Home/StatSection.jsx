const StatSection = () => {
  return (
    <div>
        <h1 className="font-bold text-3xl text-center mt-5">Toy dolls Stats</h1>
        ...
        <section className="mb-32 text-gray-800 text-center">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-x-0 items-center">
            <div className="mb-12 lg:mb-0 relative">
              ...
              <h6 className="font-medium text-gray-500">Components <br /> toy dolls</h6>
            ...
            <div className="mb-12 lg:mb-0 relative">
              ...
              <h6 className="font-medium text-gray-500">Design blocks <br /> toy dolls</h6>
              <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
            </div>
            ...
            <div className="mb-12 md:mb-0 relative">
              ...
              <h6 className="font-medium text-gray-500">Templates <br /> toy dolls</h6>
              <hr className="absolute right-0 top-0 w-px bg-gray-200 h-full hidden lg:block" />
            </div>
            ...
            <div className="relative">
              ...
              <h6 className="font-medium text-gray-500 mb-0">Plugins <br /> toy dolls</h6>
            </div>
          </div>
        </section>
        {/* <!-- Section: Design Block --> */}
